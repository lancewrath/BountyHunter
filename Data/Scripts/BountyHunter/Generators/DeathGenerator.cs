...
namespace RazMods.Hunter
{
    public class DeathGenerator
    {
        public static string[] deaths = {
            ...
            "WAAAAAAAAA",
            "EGAAAAD!!",
            "Someone Wipe my Hard Drive!! ARRRGH!!!",
            "I Forgot to delete my browsing history!!! NOOOO!!!!!",
            "I can't feel my legs!!   Oh.. They are Gone.. UGHHHH...",
            "LEEEEDLEEEDLEEEEEE!!!!",
            "FOR MARTHA!",
            "YOU'RE JUST ANOTHER KAREN AAAAGHHH!",
            "NO NO NO NONONO!!!!!",
            "SPOOOOOON!",
            "DAMMIT LAG!! NO!",
            "CURSE YOU CLANG AND YOUR TASTY COLA TOO!",
            "WHY OH WHY!?!?",
            "OH WHAT A WORLD!!!",
            "I'M MELTING??",
            "I'M IN SPACE AND I'M SCREAMING!!!",
            "REEEEEEEEEEEEEEEEEE!!!",
            "TARTER SAUCE!!",
            "FISH PASTE!",
            "Barnacles!",
            ...
            "METEOR SHI...",
            "I SEE THE LIGHT!",
            "At least the bullets were lead free ugh....",
            "I don't believe in reincarnation but i'll comeback as irratable bowel syndrom!!",
            "Everyone has to die, but i believed i was the exception!",
            "I was just 3 days from retirement AAAGHHH!",
            "I wanted to die in my sleep not like a flaming bus!!!",
            "THIS SHIP IS ON FIREEEEE!!!",
            "Not a space dog's death!",
            "Who wants to live forever!!!",
            "Yes.. Yes i do like Mudkips!!!",
            "Wendy i can fly!!!",
            "Someone put me in the Cryo before i die!",
            "I used to be a Space engineer like you until I took a grinder to the knee!!",
            "AAAHHH AHHHHA AHHHHHHH!!!",
            "YOOOOWWWWWW!!!",
            "YEEEEEEEIIIIIIIIIIIAAAAA!!",
            "NIIIIIII!",
            "I STILL NEVER GOT THAT SHRUBBARY!!",
            "·´¯`(>▂<)´¯`·",
